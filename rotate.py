...
if "__main__":
    ...
    while _end == False:
        ...
        second_circle.set_pos(first_circle.__next__(0.001))
        
        third_circle.set_pos(second_circle.__next__(0.1))
        #fifth_circle.set_pos(fourth_circle.__next__(0.5))
        screen.set_at(third_circle.__next__(1), r_color)
